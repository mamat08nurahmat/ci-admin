...
Class Contact extends CI_Controller{
    ...
    function index(){
        ...
        $data['datacontact'] = json_decode($this->curl->simple_get($this->API.'/contact/index'));
        // print_r($data);die();
    ...
    function create(){
        ...
        //         // print_r($data);die();
        //     $insert =  $this->curl->simple_post($this->API.'/contact', $data, array(CURLOPT_BUFFERSIZE => 100));
